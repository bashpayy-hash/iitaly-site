...
export const TASK_META: Record<string, { min: string; why: string; act: string }> = {
  ...
  cimea: { min: "30–60 дней", why: "признание аттестата может занять несколько недель", act: "Разобраться с признанием" },
  universitaly: { min: "40 мин", why: "государственное подтверждение поступления нужно перед студенческой визой", act: "Открыть инструкцию" },
  iseeu: { min: "1–2 недели", why: "эта справка нужна для заявки на региональную стипендию", act: "Открыть инструкцию" },
...
export const DOC_TASKS: Record<string, string> = {
  ...
  cimea: "Признание аттестата (CIMEA)",
  familyDocs: "Семейные справки для стипендии",
  iseeu: "Справка о доходах для стипендии (ISEEU)",
  statements: "Банковские выписки",
  insurance: "Медицинская страховка",
  housing: "Подтверждение жилья",
  universitaly: "Подтверждение на гос. портале (Universitaly)",
};
