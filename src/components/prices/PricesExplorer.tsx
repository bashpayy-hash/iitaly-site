        ...
        <div className="mx-auto max-w-[900px]">
          ...
          <div className="mt-8 border border-white/15 p-6 sm:p-8">
            ...
            <p className="mt-4  px-4 py-3 text-apple-body-sm text-cloud-white">
              После подтверждённой оплаты Stripe личный кабинет создаётся автоматически.
              Код доступа появится сразу на странице подтверждения.
            </p>
          ...
          <p className="mt-2 text-apple-body-sm text-cloud-body">
            Не входит в цену и не обязательно. Оплачивается через тот же защищённый
            Stripe Checkout; после оплаты мы связываемся по оставленному номеру.
          </p>
