        ...
        <div className="mx-auto max-w-[900px]">
          ...
          <div className="mt-8 border border-white/15 p-6 sm:p-8">
            ...
            <p className="mt-4  px-4 py-3 text-apple-body-sm text-cloud-white">
              После подтверждения оплаты личный кабинет активируется с персональным маршрутом.
              При автоматической оплате код доступа появится сразу на странице подтверждения.
            </p>
          ...
          <p className="mt-2 text-apple-body-sm text-cloud-body">
            Не входит в цену и не обязательно. После подтверждения оплаты мы
            связываемся по оставленному номеру и начинаем выполнение услуги.
          </p>
