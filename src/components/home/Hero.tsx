...
export function Hero() {
  return (
    <section className="border-b-2 border-ink bg-cream px-5 pt-10 pb-14 sm:pt-14 sm:pb-20">
      <div className="mx-auto grid max-w-[1200px] grid-cols-1 gap-10 lg:grid-cols-[1.3fr_0.7fr] lg:items-end">
        <div>
          ...
          <p className="mt-5 max-w-md text-lg text-ink-soft sm:text-xl">
            Подбор вузов, документы и виза — ведёт система. Один платёж
            25&nbsp;000&nbsp;₸ — без агентских наценок и подписок.
          </p>
        ...
        <div className="hidden lg:block">
          <div className="overflow-hidden rounded-xl border-2 border-ink bg-paper shadow-lg">
            <div className="p-5">
              <p className="text-xs font-extrabold tracking-[0.08em] text-sec-deep uppercase">
                Стипендия DSU
              </p>
            ...
            <div className="border-t-2 border-ink bg-ink p-5 text-cream">
              <p className="text-xs font-extrabold tracking-[0.08em] text-cream/55 uppercase">
                Вместо агентства
              </p>
