    ...
    <section className="border-b-2 border-ink px-5 py-16 sm:py-20">
      <div className="mx-auto grid max-w-[1200px] grid-cols-1 gap-5 lg:grid-cols-[1.4fr_1fr]">
        <Reveal>
          <Link
            href="/universities"
            className="group relative block overflow-hidden rounded-xl border-2 border-ink p-8 text-cream shadow-soft-md transition-[transform,box-shadow] duration-[var(--duration-normal)] ease-[var(--ease-standard)] hover:-translate-y-1 hover:shadow-soft-lg sm:p-10"
            style={{
              backgroundImage:
        ...
        <Reveal delay={0.1}>
          <Link
            href="/plan"
            className="group relative block overflow-hidden rounded-xl border-2 border-ink p-8 shadow-soft-md transition-[transform,box-shadow] duration-[var(--duration-normal)] ease-[var(--ease-standard)] hover:-translate-y-1 hover:shadow-soft-lg sm:p-10"
            style={{
              backgroundImage:
