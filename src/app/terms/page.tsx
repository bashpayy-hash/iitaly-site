          ...
          <div className="mx-auto max-w-[720px]">
            ...
            <div className="mt-8 space-y-7 text-sm text-ink-soft [&_b]:text-ink">
              ...
              <section>
                ...
                <p className="mt-1.5">
                  Основной пакет стоит <b>{priceLabel(PRICE_MAIN)}</b> разово. Оплата проходит
                  через Stripe Checkout. Реквизиты карты вводятся на стороне Stripe и не проходят
                  через сервер IITALY. После подтверждённой оплаты Stripe запускается автоматическое
                  выполнение заказа.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="mt-1.5">
                  Для основного пакета личный кабинет и персональный маршрут создаются автоматически
                  после подтверждённого webhook Stripe. Код доступа показывается на странице
                  подтверждения оплаты; затем можно подключить Telegram для напоминаний о дедлайнах.
                </p>
              </section>
